...
type Threshold struct {
	...
	Category     string    `gorm:"column:category;type:char(20);uniqueIndex;not null" json:"category"`
	MinValue     int       `gorm:"column:min_value;not null" json:"min_value"`
	MaxValue     int       `gorm:"column:max_value;not null" json:"max_value"`
	Action       string    `gorm:"column:action;type:char(10);not null" json:"action"`
	Color        string    `gorm:"column:color;type:char(20);not null" json:"color"`
