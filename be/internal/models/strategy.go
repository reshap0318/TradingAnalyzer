...
type Strategy struct {
	...
	Symbols          []StrategySymbol    `gorm:"foreignKey:StrategyID" json:"symbols,omitempty"`
}
...
type StrategyIndicator struct {
	...
	Weight        float64   `gorm:"column:weight;type:decimal(5,4);not null" json:"weight"`
	TimeframeName *string   `gorm:"column:tf;type:char(5);default:null" json:"tf"` // NULL = all TFs, "15m" = only 15m
	CreatedAt     time.Time `gorm:"autoCreateTime" json:"created_at"`
...
// StrategySymbol represents the many-to-many relationship between Strategy and trading symbols
...
func (StrategySymbol) TableName() string {
